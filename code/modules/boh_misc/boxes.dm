...
/obj/item/gunbox/officer/attack_self(mob/living/user)
	var/list/options = list()
	options["Ballistic - .454 Revolver"] = list(/obj/item/weapon/gun/projectile/revolver/medium/captain,/obj/item/weapon/storage/fancy/cigar,/obj/item/ammo_magazine/speedloader)
