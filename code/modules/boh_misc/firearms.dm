...
/obj/item/weapon/gun/projectile/pistol/magnum_pistol/solar/loaded
	name = "high-powered handgun"
	desc = "The HelTek Magnus, a robust Terran handgun that uses high-caliber ammo. This one has 'To the Chief of Security Aboard the ГЭК Наварро' engraved"
...
/obj/item/weapon/gun/projectile/pistol/holdout/cap
	...
	На рукоятке выдавлены буквы, 'ГЭК Наварро, особый заказ'."
	fire_delay = 2
	starts_loaded = 0
