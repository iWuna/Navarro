...
/client/New(TopicData)
	...
	to_chat(src, "<span class='warning'>Если экран всё ещё чёрный, это значит что ресурсы еще докачиваются. Пожалуйста, подождите окончания загрузки.</span>")
	GLOB.clients += src
	...
	if(prefs.lastchangelog != changelog_hash) //bolds the changelog button on the interface so we know there are updates.
		to_chat(src, "<span class='info'>Вы не прочли нововведения в списке обновления.</span>")
