...
#define SPECIES_UNATHI      "Унатх"
#define SPECIES_SERGAL      "Сергал"
#define SPECIES_NORTHERN    "Северный Сергал"
#define SPECIES_EASTERN     "Западный Сергал"
#define SPECIES_SKRELL      "Скрелл"
#define SPECIES_PROMETHEAN  "Прометей"
#define SPECIES_ALIEN       "Гуманоид"
#define SPECIES_ADHERENT    "Адрагент"
#define SPECIES_GOLEM       "Голем"
#define SPECIES_YEOSA       "Йоша' Унатх"
